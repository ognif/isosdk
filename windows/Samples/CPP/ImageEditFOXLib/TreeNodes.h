...
typedef std::pair<FXString,FXString> Property;
...
{
public:
	FileNode(const SFileEntry& entry, FileSysNode* fileSysNode);
...
{
public:
	static ISO9660Node* create(int track, TrackNode* trackNode, int8 fsExtension = 0);
...
protected:
	ISO9660Node(int track, TrackNode* trackNode, int8 fsExtension);
	int8 m_fsExtension;
...
public:
	...
	static FXString udfVersionToString(int32 version);
	static FXString partitionToString(int32 partition);
...
public:
	...
	static FXString sessionStatusToString(int32 status);
...
public:
	...
	static FXString mediumStatusToString(int32 status);
